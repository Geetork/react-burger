...
describe('Burger Constructor reducer', () => {
    ...
    test('initial State', () => {
        expect(burgerConstructorReducer(undefined, { type: undefined })).toEqual(initalState)
    })

    test('GET_CONSTRUCTOR_INGREDIENTS', () => {
        const state = initalState;
        expect(burgerConstructorReducer(state, { type: types.GET_CONSTRUCTOR_INGREDIENTS })).toEqual(initalState)
    })
